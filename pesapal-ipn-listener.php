...
if($pesapalNotification=="CHANGE" && $pesapalTrackingId!='')
{
   ...
   if ($status == 'COMPLETED') {
      ...
      $db_update_successful = $transaction->updateTransactionStatus($status);

      if ($db_update_successful === true) {
  ...
  // If PENDING ... we do nothing ... Pesapal will keep sending us the IPN
